...
if (category === 'menswear') {
        ...
        if (category === 'jewelry') {
            const subMap = {nose_piercing: 'nose_piercing', ear_piercing: 'ear_piercing', jhumkas: 'jhumkas', necklaces: 'necklaces', chains: 'chains', designer_bangles: 'designer_bangles'};
            const subcats = Object.values(subMap);
            if (this.currentSubcategory !== 'all' && subcats.includes(this.currentSubcategory)) {
                filtered = filtered.filter(p => p.subcategory === this.currentSubcategory);
            }
    ...
    async openProductModal(productId) {
        try {
            ...
            const discountPrice = product.discount > 0 ? Math.round(product.price * (1 - product.discount/100)) : product.price;
            ...
            body.innerHTML = `
                ...
                <div class="modal-product-info">
                    ...
                    <div class="price-section">
                        ${product.discount > 0 ? `<span class="original-price">₹${originalPrice.toLocaleString('en-IN')}</span>` : ''}
                        <span class="price">₹${discountPrice.toLocaleString('en-IN')}</span>
                    ...
                    <div class="product-details">
                        <div class="detail-item">
                            <strong><i class="fas fa-tshirt"></i> Material:</strong>
                            <span>${product.material || 'Cotton Blend'}</span>
                        </div>
                        <div class="detail-item">
                            <strong><i class="fas fa-ruler"></i> Available Sizes:</strong>
                            <span>${product.sizes.join(', ')}</span>
                        </div>
                        <div class="detail-item">
                            <strong><i class="fas fa-palette"></i> Available Colors:</strong>
                            <span>${product.colors.join(', ')}</span>
                        </div>
                        <div class="detail-item">
                            <strong><i class="fas fa-truck"></i> Delivery:</strong>
                            <span>${product.delivery_days || 5} business days</span>
                        </div>
                    </div>
